...
from viualization.common import plot_temporal_evolution, plot_hist
...
fig, axes = plt.subplots(ncols=1, nrows=1, figsize=(15, 15), sharex='all')
for name, sdf in training.groupby(by=['ref_hand']):
    plot_hist(df['VV_L'], 10, 'Variable', 'NB', 'Variables', axes, color='black', label=name, ylim=None, alpha=None)
